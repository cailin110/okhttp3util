...
import com.common.http.okhttp.utils.Exceptions;
...
public class PutJsonRequest extends OkHttpRequest {
    ...
    public PutJsonRequest(RequestBody requestBody, String content, String method, String url, Object tag, Map<String, String> params, Map<String, String> headers, int id) {
